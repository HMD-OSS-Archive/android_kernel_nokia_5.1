 ...
 *
 * $Revision: 19587 $
 * $Date: 2017-11-28 21:00:30 +0800 (週二, 28 十一月 2017) $
 *
...
static int32_t c_show_selftest(struct seq_file *m, void *v)
{
	...
	selftest_result = (TestResult_Short == 0) && (TestResult_Open == 0) && (TestResult_FWMutual == 0) && ( TestResult_FW_CC == 0) && (TestResult_FW_DiffMax == 0) && ( TestResult_FW_DiffMin == 0);

	nvt_mp_seq_printf_result(m, "%d\n", selftest_result);
