		  ...
		  void *params)
{
	...
	case DDP_DSI_DCS_CMD:
		{
			struct LCM_setting_table *dcs_cmd = (struct LCM_setting_table *)params;
			DSI_set_cmdq_V2(module, cmdq_handle, dcs_cmd->cmd, dcs_cmd->count, dcs_cmd->para_list, 1);
			break;
		}
